...
export class SeedInitialDataSqlite1761271015937 implements MigrationInterface {
    name = 'SeedInitialDataSqlite1761271015937';
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM reserves;`);
